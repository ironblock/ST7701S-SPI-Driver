...
where
    Self: Device + Stateful<DeviceState>,
{
    /// ## No Operation
    ///
    ...
    pub fn read_display_id(&mut self) -> ReadResult<RDDID> {
        self.read::<RDDID>()
    }
    ...
    pub fn read_dsi_errors(&mut self) -> ReadResult<RDNUMED> {
        self.read::<RDNUMED>()
    }
    ...
    pub fn read_first_pixel_color(&mut self, channel: ColorChannel) -> ReadResult<RDRED> {
        match channel {
            ColorChannel::Red => self.read::<RDRED>(),
            ColorChannel::Green => self.read::<RDGREEN>(),
            ColorChannel::Blue => self.read::<RDBLUE>(),
        }
    }

    /// ### `0x0A` `RDDPM`  Read Display Power Mode
    /// > Reference: p. 194
    pub fn read_display_power_mode(&mut self) -> ReadResult<RDDPM> {
        self.read::<RDDPM>()
    }

    /// ### `0x0B` `RDDMADCTL`  Read Display MADCTL
    /// > Reference: p. 195
    pub fn read_display_madctl(&mut self) -> ReadResult<RDDMADCTL> {
        self.read::<RDDMADCTL>()
    }
    ...
    pub fn get_scan_line(&mut self) -> ReadResult<GSL> {
        self.read::<GSL>()
    }
    ...
    pub fn brightness_control(
        &'_ mut self,
    ) -> Configure<'_, Self, BrightnessControl, RDCTRLD, WRCTRLD> {
    ...
    /// > Reference: p. 202
    ///
    pub fn enable_partial_mode(&'_ mut self) -> io::Result<usize> {
    ...
    /// > Reference: p. 203
    ///
    pub fn enable_normal_mode(&'_ mut self) -> io::Result<usize> {
    ...
    // /// (CABC).
    // pub fn min_adaptive_brightness(&'_ mut self) -> Configure<'_, Self, u8, WRCABCMB, RDCABCMB> {
    ...
    pub fn read_adaptive_brightness_diagnostic(&mut self) -> ReadResult<RDABCSDR> {
        self.read::<RDABCSDR>()
    }
    ...
    /// and diagnostics.
    pub fn read_black_white_low_bits(&mut self) -> ReadResult<RDBWLB> {
        self.read::<RDBWLB>()
    }
    ...
    pub fn read_bkx(&mut self) -> ReadResult<RDBKX> {
        self.read::<RDBKX>()
    }
    ...
    pub fn read_bky(&mut self) -> ReadResult<RDBKY> {
        self.read::<RDBKY>()
    }
    ...
    pub fn read_wx(&mut self) -> ReadResult<RDWX> {
        self.read::<RDWX>()
    }
    ...
    pub fn read_wy(&mut self) -> ReadResult<RDWY> {
        self.read::<RDWY>()
    }
    ...
    pub fn read_rx(&mut self) -> ReadResult<RDRX> {
        self.read::<RDRX>()
    }
    ...
    pub fn read_ry(&mut self) -> ReadResult<RDRY> {
        self.read::<RDRY>()
    }
    ...
    pub fn read_gx(&mut self) -> ReadResult<RDGX> {
        self.read::<RDGX>()
    }
    ...
    pub fn read_gy(&mut self) -> ReadResult<RDGY> {
        self.read::<RDGY>()
    }
    ...
    /// diagnostics.
    pub fn read_blue_low_bits(&mut self) -> ReadResult<RDBALB> {
        self.read::<RDBALB>()
    }
    ...
    pub fn read_bx(&mut self) -> ReadResult<RDBX> {
        self.read::<RDBX>()
    }
    ...
    pub fn read_by(&mut self) -> ReadResult<RDBY> {
        self.read::<RDBY>()
    }
    ...
    pub fn read_ax(&mut self) -> ReadResult<RDAX> {
        self.read::<RDAX>()
    }
    ...
    pub fn read_ay(&mut self) -> ReadResult<RDAY> {
        self.read::<RDAY>()
    }
    ...
    pub fn read_ddbs(&mut self) -> ReadResult<RDDDBS> {
        self.read::<RDDDBS>()
    }
    ...
    pub fn read_ddbc(&mut self) -> ReadResult<RDDDBC> {
        self.read::<RDDDBC>()
    }
    ...
    pub fn read_fcs(&mut self) -> ReadResult<RDFCS> {
        self.read::<RDFCS>()
    }
    ...
    pub fn read_ccs(&mut self) -> ReadResult<RDCCS> {
        self.read::<RDCCS>()
    }
    ...
    pub fn read_id1(&mut self) -> ReadResult<RDID1> {
        self.read::<RDID1>()
    }
    ...
    pub fn read_id2(&mut self) -> ReadResult<RDID2> {
        self.read::<RDID2>()
    }
    ...
    pub fn read_id3(&mut self) -> ReadResult<RDID3> {
        self.read::<RDID3>()
    }
    ...
    /// negative voltages.
    pub fn negative_gamma_control(&mut self, gamma_params: &[u8; 16]) -> io::Result<usize> {
        self.write::<NVGAMCTRL>(*gamma_params)
    }
    ...
    pub fn digital_gamma_enable(&mut self, enable: u8) -> io::Result<usize> {
    ...
    pub fn digital_gamma_lut_red(&mut self, lut_data: &GammaLutRed) -> io::Result<usize> {
    ...
    /// defines the gamma correction for a specific input value.
    pub fn digital_gamma_lut_blue(&mut self, lut_data: &GammaLutBlue) -> io::Result<usize> {
    ...
    pub fn pwm_clock_select(&mut self, clock_setting: u8) -> io::Result<usize> {
    ...
    pub fn line_setting(&mut self, settings: &LineSettings) -> io::Result<usize> {
        let params = [settings.line_delta_enable, settings.line_delta];
        self.write::<LNESET>(params)
    }
    ...
    pub fn porch_control(&mut self, settings: &PorchControl) -> io::Result<usize> {
        let params = [settings.vertical_back_porch, settings.vertical_front_porch];
        self.write::<PORCTRL>(params)
    }
    ...
    pub fn inversion_select(&mut self, settings: &InversionSettings) -> io::Result<usize> {
        let params = [settings.inversion_mode, settings.rtni];
        self.write::<INVSET>(params)
    }
    ...
    pub fn partial_area(&mut self, settings: &PartialControl) -> io::Result<usize> {
        let params = [settings.start_config, settings.end_config];
        self.write::<PARCTRL>(params)
    }
    ...
    pub fn scan_direction(&mut self, direction: u8) -> io::Result<usize> {
        self.write::<SDIR>([direction])
    }
    ...
    /// reduce artifacts.
    pub fn pseudo_dot_inversion(&mut self, setting: u8) -> io::Result<usize> {
        self.write::<PDOSET>([setting])
    }
    ...
    /// backlight behavior.
    pub fn color_control(&mut self, setting: u8) -> io::Result<usize> {
        self.write::<COLCTRL>([setting])
    }
    ...
    pub fn sunlight_readable_enhancement(&mut self, params: [u8; 3]) -> io::Result<usize> {
        self.write::<SRECTRL>(params)
    }
    ...
    /// artifacts.
    pub fn noise_reduction_control(&mut self, params: [u8; 11]) -> io::Result<usize> {
        self.write::<NRCTRL>(params)
    }
    ...
    pub fn sharpness_control(&mut self, params: [u8; 13]) -> io::Result<usize> {
        self.write::<SECTRL>(params)
    }
    ...
    pub fn color_calibration_control(&mut self, params: [u8; 4]) -> io::Result<usize> {
        self.write::<CCCTRL>(params)
    }
    ...
    pub fn skin_tone_control(&mut self, params: [u8; 2]) -> io::Result<usize> {
        self.write::<SKCTRL>(params)
    }
    ...
    pub fn nvm_set_enable(&mut self, enable: u8) -> io::Result<usize> {
    ...
    pub fn cabc_control(&mut self, setting: u8) -> io::Result<usize> {
    ...
    pub fn deep_standby_enable(&mut self) -> io::Result<usize> {
    ...
    pub fn deep_standby_active(&mut self) -> io::Result<usize> {
    ...
    pub fn vop_amplitude_setting(&mut self, voltage: u8) -> io::Result<usize> {
        self.write::<VRHS>([voltage])
    }
    ...
    pub fn vcom_setting(&mut self, voltage: u8) -> io::Result<usize> {
        self.write::<VCOMS>([voltage])
    }
    ...
    pub fn vgh_setting(&mut self, voltage: u8) -> io::Result<usize> {
        self.write::<VGHSS>([voltage])
    }
    ...
    pub fn test_command(&mut self, command: u8) -> io::Result<usize> {
        self.write::<TESTCMD>([command])
    }
    ...
    pub fn vgl_setting(&mut self, voltage: u8) -> io::Result<usize> {
        self.write::<VGLS>([voltage])
    }
    ...
    pub fn power_control_1(&mut self, setting: u8) -> io::Result<usize> {
        self.write::<PWCTRL1>([setting])
    }
    ...
    pub fn power_control_2(&mut self, setting: u8) -> io::Result<usize> {
        self.write::<PWCTRL2>([setting])
    }
    ...
    pub fn panel_clock_setting_1(&mut self, setting: u8) -> io::Result<usize> {
        self.write::<PCLKS1>([setting])
    }
    ...
    pub fn panel_clock_setting_2(&mut self, setting: u8) -> io::Result<usize> {
        self.write::<PCLKS2>([setting])
    }
    ...
    pub fn panel_clock_setting_3(&mut self, setting: u8) -> io::Result<usize> {
        self.write::<PCLKS3>([setting])
    }
    ...
    pub fn source_pre_drive_timing_1(&mut self, setting: u8) -> io::Result<usize> {
        self.write::<SPD1>([setting])
    }
    ...
    pub fn speed_control_2(&mut self, setting: u8) -> io::Result<usize> {
        self.write::<SPD2>([setting])
    }
    ...
    pub fn mipi_setting_1(&mut self, setting: u8) -> io::Result<usize> {
        self.write::<MIPISET1>([setting])
    }
    ...
    pub fn mipi_setting_2(&mut self, params: [u8; 15]) -> io::Result<usize> {
        self.write::<MIPISET2>(params)
    }
    ...
    pub fn mipi_setting_3(&mut self, setting: u8) -> io::Result<usize> {
        self.write::<MIPISET3>([setting])
    }
    ...
    pub fn mipi_setting_4(&mut self, setting: u8) -> io::Result<usize> {
        self.write::<MIPISET4>([setting])
    }
    ...
    pub fn nvm_setting(&mut self, setting: u8) -> io::Result<usize> {
    ...
    pub fn prom_activation(&mut self, setting: u8) -> io::Result<usize> {
